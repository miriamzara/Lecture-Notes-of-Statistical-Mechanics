...
% 1. ESSENTIAL CORE PACKAGES
\usepackage[english]{babel}   
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}   % Note: Modern TeX handles this automatically, but safe to keep
\usepackage{microtype}
\usepackage{subfiles}
\usepackage{float}

% 2. INPUT YOUR CUSTOM CONFIGS (The "Brains" of the document)
\input{../Utility/packages.tex}
\input{../Utility/settings.tex}
\input{../Utility/new_commands.tex}

% 3. LSTLISTING CONFIGURATION (Keep this after packages.tex)
...
% 4. GEOMETRY & LAYOUT
% I updated the headheight here to fix your Terminal Warning!
\geometry{
    left=2.5cm,
    right=2.5cm,
    top=2.5cm,
    bottom=2.5cm,
    headheight=26pt % Fixes the fancyhdr warning
}
