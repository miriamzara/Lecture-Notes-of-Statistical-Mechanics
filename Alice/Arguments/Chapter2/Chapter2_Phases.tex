...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{./img/3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{./img/5.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{./img/11.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{./img/12.pdf}
...
\includegraphics[width=0.95\textwidth]{./img/7_1.pdf}
\label{fig:} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Continuous \( s \).]{\centering
\includegraphics[width=0.95\textwidth]{./img/7_2.pdf}
\label{fig:} }
\end{minipage}
\\
\begin{minipage}[c]{0.5\linewidth}
...
\includegraphics[width=0.95\textwidth]{./img/7_3.pdf}
\label{fig:} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Discontinuous \( c_P \), transition from superconductive to normal.]{\centering
\includegraphics[width=0.95\textwidth]{./img/7_4.pdf}
\label{fig:2_7_4}  }
\end{minipage}
...
\includegraphics[width=0.9\textwidth]{./img/8.pdf}
\label{fig:2_8_1}}
\end{minipage}
\begin{minipage}[]{0.5\linewidth} 
\centering
\subfloat[][\( (P,V) \) projection.]{\centering
\includegraphics[width=0.9\textwidth]{./img/9.pdf}
\label{fig:2_8_2}}
\end{minipage}
...
\centering
\subfloat[][]{
\includegraphics[width=1\textwidth]{./img/6__2.pdf}
    \label{fig:} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Liquid gas \( k_T = - \frac{1}{V} \pdv{V}{P}  \) ]{
\includegraphics[width=1\textwidth]{./img/7__2.pdf}
    \label{fig:} }
\end{minipage}
\\
\begin{minipage}[c]{0.5\linewidth}
...
\includegraphics[width=1\textwidth]{./img/9.pdf}
    \label{fig:3_04_4} }
\end{minipage}
...
\begin{example}{}{}
In a fluid system since at \( T=T_c \) the curve \( P = P(V) \) develops an horizontal flex , we have \( k_T = -\frac{1}{V} \qty(\pdv{V}{P} )_T  \rightarrow \infty  \). Similarly, in a magnetic since the curve is like Figure \ref{fig:3_3}, we have \( \chi _T = \qty(\pdv{M}{H} )_T \underset{T \rightarrow  T_c}{\rightarrow } \infty   \).
...
\includegraphics[width=1\textwidth]{./img/10__2.pdf}
    \label{fig:3_4_1} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Exponent \( \gamma_{\pm}  \).]{
\includegraphics[width=1\textwidth]{./img/11__2.pdf}
    \label{fig:3_4_2} }
\end{minipage}
\\
\begin{minipage}[c]{0.5\linewidth}
...
\includegraphics[width=1\textwidth]{./img/13__2.pdf}
    \label{fig:3_4_4} }
\end{minipage}
\caption{\label{fig:}}
\end{figure}
...
\end{tabular}
\end{center}
\caption{\label{tab:3_1} Definitions of the most commonly used critical exponents for a magnetic system}
\end{table}
...
\end{tabular}
\end{center}
\caption{ \label{tab:3_2} Definitions of the most commonly used critical exponents for a fluid system}
\end{table}
...
\end{remark}
Critical exponents depend on very few parameters and are not system-specific:\begin{enumerate}
\itemsep0em
	\item Symmetries of the System
	\item Dimensions of the System
...
\includegraphics[width=1\textwidth]{./img/14__2.pdf}
    \label{fig:3_5} }
\end{minipage}
\begin{minipage}[]{0.5\linewidth}
\centering
\subfloat[][Coexistence curve of different fluids plotted in reduced variables.]{   \centering
\includegraphics[width=1\textwidth]{./img/15__2.pdf}
    \label{fig:3_6} }
\end{minipage}
\caption{\label{fig:} }
\end{figure}
